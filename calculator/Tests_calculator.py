...
class TestCalculator(unittest.TestCase):
    ...
    def test_Vector_evaluate_expression(self):
        #self.assertEqual(evaluate_expression('{}'), "Ошибка")
        #self.assertEqual(evaluate_expression('{23;23;;}'), "Ошибка")
        #self.assertEqual(evaluate_expression('{-91;78;3} - {3;1;0}'), Vector(-94,77,3))
        ...
        self.assertEqual(evaluate_expression('( -3 * ( 16 ^ 2 - 34 * 3 ) + 2 ^ ( 2 ^ 3 ) ) - {9;78992;309} * {32;23;23}'), -1824417)
    ...
    def test_Vector_Error(self):
        ...
        self.assertEqual(evaluate_expression('{-1;-2;-3} / {3;1;1}'), 'Ошибка при вычислении выражения')
         #тесты на которых ломается программа
        #self.assertEqual(evaluate_expression('{}'), 'Ошибка')
        #self.assertEqual(evaluate_expression('{23;23;;}, 'Ошибка')
        #self.assertEqual(evaluate_expression('{dsdsds}'), 'Ошибка')
